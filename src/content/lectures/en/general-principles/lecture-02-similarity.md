...
![Scale-up scheme: laboratory, pilot plant, industrial production](/images/lectures/general-principles/scale-up-similarity.svg)

🔗 **Discussion case:** [GEA Application and Technology Center](https://www.gea.com/en/products/bioreactor-fermentation-systems/new-food-application-technology-center-excellence/) — an example of pilot infrastructure where food and biotechnology processes are checked before industrial scale-up.
...
> **Engineering hint:** geometric similarity is easy to draw, but in food processing dynamic similarity is usually the fragile part. The viscosity of sauce, puree, or chocolate mass can change $Re$ so much that the larger apparatus behaves not like an enlarged lab vessel, but like a different system.
...
![Map of dimensionless similarity criteria by physical meaning](/images/lectures/general-principles/dimensionless-groups-map.svg)
...
🔗 **Practical reading:** [Tetra Pak: viscous products and heat transfer](https://www.tetrapak.com/en-us/insights/cases-articles/viscous-products-and-heat-transfer) — why ketchup, yoghurt, baby food, or hummus cannot be designed from "one" viscosity value.
...
If the model is smaller by a factor of 10 ($l_{\text{model}} = 0{,}1 \cdot l_{\text{prototype}}$), then to achieve equality of Re either increase velocity by 10 times, or reduce fluid viscosity by 10 times (use a different fluid).
...
🔗 **CFD example:** [Tetra Pak: optimize mixing process and food quality using CFD](https://www.tetrapak.com/en-in/insights/cases-articles/optimize-mixing-process-food-quality-cfd) — how simulation helps select mixers for viscous foods such as tomato paste, cream cheese, or hummus.
...
🔗 **Modern infrastructure example:** [Alfa Laval Food Innovation Center](https://www.alfalaval.us/media/news/2026/a-groundbreaking-facility/) — a facility where manufacturers, startups, and universities can test food processes before large-scale launch.
...
### Online Calculators
- 🔗 [Reynolds Number Calculator](https://www.engineeringtoolbox.com/reynolds-number-d_237.html) — flow-regime explanation and online Re calculation
...
### Practical Materials
- 🔗 [Tetra Pak: CFD for food mixing](https://www.tetrapak.com/en-in/insights/cases-articles/optimize-mixing-process-food-quality-cfd) — an example of CFD use for food mixers
- 🔗 [GEA New Food Application & Technology Center](https://www.gea.com/en/unitedstates/protein-food-beverage-pilot-testing-development-wi/) — an example of a pilot center for scaling food processes
