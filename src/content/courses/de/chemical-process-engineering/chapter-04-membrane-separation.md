---
title: "Kapitel 4. Membrantrennprozesse"
course: "chemical-process-engineering"
course_title: "Prozesse und Apparate der chemischen Produktion"
chapter: 4
description: "Umkehrosmose, Nano-, Ultra- und Mikrofiltration, Diafiltration und Membranapparate."
updated: "2026-08-27"
---
...
- 4.2. Theoretische Grundlagen druckgetriebener Membranprozesse
- 4.3. Diafiltration
- 4.4. Membranapparate
...
Membrantrennprozesse verwenden semipermeable Trennschichten, die bestimmte Komponenten passieren lassen und andere zurueckhalten. In chemischen Produktionen dienen sie zur Konzentrierung von Proteinen, Enzymen, Antibiotika, Impfstoff-Zwischenprodukten und Kulturbruehen sowie zur Wasseraufbereitung, Entsalzung und sterilen Filtration thermolabiler Loesungen.
...
![Abb. 4.1. Schemata von Osmose und Umkehrosmose](/images/courses/chemical-process-engineering/chapter-04/fig-4-1.webp)
...
Diafiltration kombiniert Membrantrennung mit Zugabe von Loesungsmittel. Sie entfernt niedermolekulare Verunreinigungen aus Loesungen hochmolekularer Produkte bei geringen Produktverlusten. In der chemischen Produktion ist sie fuer Konzentrate, Polymerloesungen und Prozesswasser nuetzlich.
...
![Abb. 4.2. Prinzipschemata der Diafiltration](/images/courses/chemical-process-engineering/chapter-04/fig-4-2.webp)

### 4.4. Membranapparate

Membranapparate muessen grosse Membranflaeche, gleichmaessige Stroemungsverteilung, Reinigbarkeit, Sanitation und Austausch der Membranelemente ermoeglichen. Fuer chemische Medien sind Werkstoffbestaendigkeit, Foulingkontrolle, Dichtheit und stabile Betriebsbedingungen wichtig.

Apparate vom Typ Filterpresse eignen sich fuer Flachmembranen sowie Labor- und Pilotanlagen.

![Abb. 4.3. Membranapparat vom Typ Filterpresse](/images/courses/chemical-process-engineering/chapter-04/fig-4-3.webp)

Rohrfoermige Membranelemente sind foulingrobust und fuer viskose oder verschmutzte Suspensionen geeignet.

![Abb. 4.4. Schemata rohrfoermiger Membranelemente](/images/courses/chemical-process-engineering/chapter-04/fig-4-4.webp)
...
![Abb. 4.6. Modul mit Hohlfasermembranen](/images/courses/chemical-process-engineering/chapter-04/fig-4-6.webp)
...
![Abb. 4.7. Periodisch arbeitender baromembraner Apparat](/images/courses/chemical-process-engineering/chapter-04/fig-4-7.webp)
...
![Abb. 4.8. Kontinuierliche baromembrane Apparate mit Zirkulationskreisen](/images/courses/chemical-process-engineering/chapter-04/fig-4-8.webp)

## Nach dem Durcharbeiten dieses Kapitels sollen Studierende

- die Rolle von "Membran" im Kapitel erklaeren;
- "Umkehrosmose" mit der apparativen Gestaltung chemischen Produktion verbinden;
- wichtige Einflussgroessen fuer "Ultrafiltration" unterscheiden;
- die Auswahl oder Bewertung des Prozesses ueber "Diafiltration" begruenden.
...
<label class="course-test-option">
  ...
  <span class="course-test-letter">A</span>
  <span>4.2. Theoretische Grundlagen druckgetriebener Membranprozesse</span>
</label>
<label class="course-test-option">
  <input type="radio" name="course-test-4-1" value="1" data-correct="1" />
  <span class="course-test-letter">B</span>
  <span>4.1. Allgemeine Grundlagen</span>
</label>
<label class="course-test-option">
...
<label class="course-test-option">
  ...
  <span class="course-test-letter">A</span>
  <span>Membran / Umkehrosmose</span>
</label>
<label class="course-test-option">
...
<label class="course-test-option">
  ...
  <span class="course-test-letter">C</span>
  <span>Membran / Ultrafiltration</span>
</label>
<label class="course-test-option">
  <input type="radio" name="course-test-4-8" value="3" data-correct="0" />
  <span class="course-test-letter">D</span>
  <span>Umkehrosmose / Diafiltration</span>
</label>
</div>
<p class="course-test-feedback" data-course-test-feedback></p>
</fieldset>
...
<label class="course-test-option">
  ...
  <span class="course-test-letter">D</span>
  <span>Schemata von Osmose und Umkehrosmose</span>
</label>
</div>
<p class="course-test-feedback" data-course-test-feedback></p>
</fieldset>
