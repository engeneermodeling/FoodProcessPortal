...
Під час наступного проходу варто звірити формули фільтрування і потужності центрифуг з друкованим макетом підручника та додати розрахунковий приклад відстійника або фільтр-преса.
