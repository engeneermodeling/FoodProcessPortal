...
Під час наступного проходу варто звірити формули й підписи рисунків із друкованим макетом підручника та додати розрахунковий приклад для насосної установки.
