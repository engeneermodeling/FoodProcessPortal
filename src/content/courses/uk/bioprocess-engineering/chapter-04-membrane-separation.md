---
title: "Розділ 4. Мембранні процеси розділення"
course: "bioprocess-engineering"
course_title: "Інжиніринг біопроцесів: процеси та апарати біотехнологічних виробництв"
chapter: 4
description: "Зворотний осмос, нано-, ультра- і мікрофільтрація, діафільтрація та мембранні апарати."
updated: "2026-08-23"
---
...
- 4.2. Теоретичні основи баромембранних процесів
- 4.3. Діафільтрація
...
![Рис. 4.1. Схеми осмотичного і зворотноосмотичного процесів](/images/courses/bioprocess-engineering/chapter-04/fig-4-1.webp)
...
![Рис. 4.2. Принципові схеми діафільтрації](/images/courses/bioprocess-engineering/chapter-04/fig-4-2.webp)
...
![Рис. 4.3. Мембранний апарат типу фільтр-прес](/images/courses/bioprocess-engineering/chapter-04/fig-4-3.webp)

Трубчасті мембранні елементи стійкі до забруднення і придатні для в'язких або забруднених суспензій.

![Рис. 4.4. Схеми трубчастих мембранних елементів](/images/courses/bioprocess-engineering/chapter-04/fig-4-4.webp)
...
![Рис. 4.6. Модуль з мембранами у вигляді порожнистих волокон](/images/courses/bioprocess-engineering/chapter-04/fig-4-6.webp)
...
![Рис. 4.7. Баромембранний апарат періодичної дії](/images/courses/bioprocess-engineering/chapter-04/fig-4-7.webp)
...
![Рис. 4.8. Баромембранні апарати безперервної дії з циркуляційними контурами](/images/courses/bioprocess-engineering/chapter-04/fig-4-8.webp)

## Після опрацювання розділу студент має вміти

- пояснювати роль поняття «мембрана» у межах розділу;
- пов'язувати «зворотний осмос» з апаратурним оформленням біотехнологічного виробництва;
- розрізняти основні параметри, що впливають на «ультрафільтрація»;
- обґрунтовувати вибір або оцінку процесу через «діафільтрація».
...
<label class="course-test-option">
  ...
  <span class="course-test-letter">D</span>
  <span>Схеми осмотичного і зворотноосмотичного процесів</span>
</label>
</div>
<p class="course-test-feedback" data-course-test-feedback></p>
</fieldset>
...
Під час наступного проходу варто додати короткий розрахунковий приклад продуктивності мембрани та порівняльну таблицю RO/NF/UF/MF для біотехнологічних задач.
