...
Кристалізація - масообмінний процес утворення твердої фази у вигляді кристалів із розчинів, розплавів, газів або пари. У харчових і хімічних виробництвах вона використовується для одержання та очищення цукрози, глюкози, лактози, фруктози, лимонної кислоти, солей та інших кристалічних продуктів.
...
![Кристал цукрози](/images/courses/chemical-process-engineering/chapter-15/fig-15-1.webp)
...
![Графік розчинності двокомпонентної системи цукроза - вода](/images/courses/chemical-process-engineering/chapter-15/fig-15-2.webp)
...
![Кінематичні криві кристалізації](/images/courses/chemical-process-engineering/chapter-15/fig-15-3.webp)
...
![Вакуум-апарат типу А2-ПВР](/images/courses/chemical-process-engineering/chapter-15/fig-15-5.webp)
*Рис. 15.5. Вакуум-апарат типу А2-ПВР*

![Схема потоків безперервного уварювання та кристалізації цукрових утфелів](/images/courses/chemical-process-engineering/chapter-15/fig-15-6.webp)
*Рис. 15.6. Схема потоків безперервного уварювання та кристалізації цукрових утфелів*

![Вакуум-апарат безперервної дії системи КТІХП: а - структурна схема; б - конструкція](/images/courses/chemical-process-engineering/chapter-15/fig-15-7.webp)
*Рис. 15.7. Вакуум-апарат безперервної дії системи КТІХП: а - структурна схема; б - конструкція*

![Горизонтальний перемішувач-кристалізатор](/images/courses/chemical-process-engineering/chapter-15/fig-15-8.webp)
*Рис. 15.8. Горизонтальний перемішувач-кристалізатор*

![Вертикальний перемішувач-кристалізатор](/images/courses/chemical-process-engineering/chapter-15/fig-15-9.webp)
...
![Схема статичного матеріального балансу багатоступеневої кристалізації](/images/courses/chemical-process-engineering/chapter-15/fig-15-10.webp)
*Рис. 15.10. Схема статичного матеріального балансу багатоступеневої кристалізації*

![Масовий графік варіння та кристалізації цукрових утфелів у вакуум-апараті та перемішувачі-кристалізаторі](/images/courses/chemical-process-engineering/chapter-15/fig-15-11.webp)
...
- пов'язувати «зародкоутворення» з апаратурним оформленням хімічного виробництва;
