...
## Джерела і межі розділу

Основу лекції становить конспект "Курс лекцій_1" з дисципліни "Процеси і апарати хімічних виробництв". Апаратурні приклади і медіа взято з віртуального підручника `MAHP_BOOK`: використано лише нейтральні рисунки та англомовне відео, без ГОСТів як нормативної бази.
...
## Відео з віртуального підручника

Нижче залишено короткий англомовний відеофрагмент з віртуального підручника. Він потрібен не як заміна лекції, а як візуальний приклад роботи апаратів теплопередачі.
