...
Екстрагування - масообмінний процес вилучення одного або кількох компонентів із твердої чи рідкої складної речовини розчинником, який вибірково розчиняє цільову речовину. У хімічних і харчових виробництвах цей процес використовують для одержання ферментів, екстрактів рослинної сировини, ароматичних, біологічно активних та інших цільових компонентів.
...
![Способи оброблення сировини перед екстрагуванням](/images/courses/chemical-process-engineering/chapter-14/fig-14-1.webp)
*Рис. 14.1. Способи оброблення сировини перед екстрагуванням*

![Класифікація екстрагентів](/images/courses/chemical-process-engineering/chapter-14/fig-14-2.webp)
...
![Схема перенесення маси цільового компонента](/images/courses/chemical-process-engineering/chapter-14/fig-14-3.webp)
...
![Екстракційні криві протитечійного і прямотечійного процесів](/images/courses/chemical-process-engineering/chapter-14/fig-14-4.webp)
...
![Трикутна діаграма для системи тверде тіло - рідина](/images/courses/chemical-process-engineering/chapter-14/fig-14-5.webp)
...
![Визначення складу та кількості утворених сумішей](/images/courses/chemical-process-engineering/chapter-14/fig-14-6.webp)
*Рис. 14.6. Визначення складу та кількості утворених сумішей*

![Схема n-секційного протитечійного екстрагування](/images/courses/chemical-process-engineering/chapter-14/fig-14-7.webp)
*Рис. 14.7. Схема n-секційного протитечійного екстрагування*

![Графічний розрахунок багатоступінчастого протитечійного екстрагування з твердих тіл](/images/courses/chemical-process-engineering/chapter-14/fig-14-8.webp)
*Рис. 14.8. Графічний розрахунок багатоступінчастого протитечійного екстрагування з твердих тіл*

![Графічне визначення кількості ступенів концентрації](/images/courses/chemical-process-engineering/chapter-14/fig-14-9.webp)
...
![Класифікація методів інтенсифікації процесу екстрагування](/images/courses/chemical-process-engineering/chapter-14/fig-14-10.webp)
*Рис. 14.10. Класифікація методів інтенсифікації процесу екстрагування*

![Загальна класифікація апаратів для екстрагування з твердих тіл](/images/courses/chemical-process-engineering/chapter-14/fig-14-11.webp)
*Рис. 14.11. Загальна класифікація апаратів для екстрагування з твердих тіл*

![Класифікація екстракційної апаратури за режимом роботи](/images/courses/chemical-process-engineering/chapter-14/fig-14-12.webp)
...
![Схеми екстракторів періодичної дії](/images/courses/chemical-process-engineering/chapter-14/fig-14-13.webp)
*Рис. 14.13. Схеми екстракторів періодичної дії*

![Екстрактор з висхідним потоком екстрагента](/images/courses/chemical-process-engineering/chapter-14/fig-14-14.webp)
*Рис. 14.14. Екстрактор з висхідним потоком екстрагента*

![Екстрактор зі спадним потоком екстрагента](/images/courses/chemical-process-engineering/chapter-14/fig-14-15.webp)
*Рис. 14.15. Екстрактор зі спадним потоком екстрагента*

![Комбінований екстрактор періодичної дії](/images/courses/chemical-process-engineering/chapter-14/fig-14-16.webp)
*Рис. 14.16. Комбінований екстрактор періодичної дії*

![Екстрактор з кавітаційним ефектом](/images/courses/chemical-process-engineering/chapter-14/fig-14-17.webp)
*Рис. 14.17. Екстрактор з кавітаційним ефектом*

![Віброекстрактор із сітчастим контейнером](/images/courses/chemical-process-engineering/chapter-14/fig-14-18.webp)
*Рис. 14.18. Віброекстрактор із сітчастим контейнером*

![Ротаційна дифузійна установка](/images/courses/chemical-process-engineering/chapter-14/fig-14-19.webp)
*Рис. 14.19. Ротаційна дифузійна установка*

![Схема шнекового горизонтального екстрактора](/images/courses/chemical-process-engineering/chapter-14/fig-14-20.webp)
*Рис. 14.20. Схема шнекового горизонтального екстрактора*

![Шнековий горизонтальний екстрактор](/images/courses/chemical-process-engineering/chapter-14/fig-14-21.webp)
*Рис. 14.21. Шнековий горизонтальний екстрактор*

![Пружинно-лопатевий горизонтальний екстрактор](/images/courses/chemical-process-engineering/chapter-14/fig-14-22.webp)
*Рис. 14.22. Пружинно-лопатевий горизонтальний екстрактор*

![Екстрактор нахиленого типу](/images/courses/chemical-process-engineering/chapter-14/fig-14-23.webp)
*Рис. 14.23. Екстрактор нахиленого типу*

![Двоколонний екстрактор типу НД-1000](/images/courses/chemical-process-engineering/chapter-14/fig-14-24.webp)
*Рис. 14.24. Двоколонний екстрактор типу НД-1000*

![Принципова схема віброекстрактора](/images/courses/chemical-process-engineering/chapter-14/fig-14-25.webp)
*Рис. 14.25. Принципова схема віброекстрактора*

![Вібротранспортувальна тарілка](/images/courses/chemical-process-engineering/chapter-14/fig-14-26.webp)
*Рис. 14.26. Вібротранспортувальна тарілка*

![Вібраційний екстрактор](/images/courses/chemical-process-engineering/chapter-14/fig-14-27.webp)
...
- пов'язувати «тверде тіло - рідина» з апаратурним оформленням біохімічного виробництва;
