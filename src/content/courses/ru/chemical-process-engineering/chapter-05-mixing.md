...
Перемешивание применяют для выравнивания концентрации, температуры и физических свойств среды, интенсификации тепло- и массообмена, поддержания твердых частиц во взвешенном состоянии, диспергирования газа или жидкости и ускорения биохимических реакций. В химических аппаратах оно должно обеспечивать обмен, но не повреждать клетки, ферменты и чувствительные белковые продукты.
...
![Рис. 5.2. Пример механического перемешивания](/images/courses/chemical-process-engineering/chapter-05/fig-5-2.webp)

![Рис. 5.3. Схемы потоков в аппаратах с отражательными перегородками и мешалками](/images/courses/chemical-process-engineering/chapter-05/fig-5-3.webp)
...
![Рис. 5.5. Зависимость Eu<sub>m</sub> от Re<sub>m</sub> для разных типов мешалок](/images/courses/chemical-process-engineering/chapter-05/fig-5-5.webp)

![Рис. 5.6. Типы мешалок для экспериментальных кривых мощности](/images/courses/chemical-process-engineering/chapter-05/fig-5-6.webp)
...
![Рис. 5.8. Схемы лопастных мешалок](/images/courses/chemical-process-engineering/chapter-05/fig-5-8.webp)

![Рис. 5.9. Лопастная мешалка с планетарным приводом](/images/courses/chemical-process-engineering/chapter-05/fig-5-9.webp)

![Рис. 5.10. Трехлопастной винт пропеллерной мешалки](/images/courses/chemical-process-engineering/chapter-05/fig-5-10.webp)

![Рис. 5.11. Турбинное колесо с направляющим устройством](/images/courses/chemical-process-engineering/chapter-05/fig-5-11.webp)
...
![Рис. 5.14. Схемы барботажного смесителя и барботеров](/images/courses/chemical-process-engineering/chapter-05/fig-5-14.webp)

![Рис. 5.15. Аппараты для пневматического перемешивания и аэрации](/images/courses/chemical-process-engineering/chapter-05/fig-5-15.webp)
...
![Рис. 5.16. Схема движения жидкости, выходящей из погруженного сопла](/images/courses/chemical-process-engineering/chapter-05/fig-5-16.webp)

![Рис. 5.19. Схема циркуляционного перемешивания](/images/courses/chemical-process-engineering/chapter-05/fig-5-19.webp)
...
![Рис. 5.22. Перемешивающие устройства для сыпучих и пластичных масс](/images/courses/chemical-process-engineering/chapter-05/fig-5-22.webp)

## После изучения раздела студент должен уметь

- объяснять роль понятия «мешалка» в пределах раздела;
- связывать «циркуляция» с аппаратурным оформлением химического производства;
