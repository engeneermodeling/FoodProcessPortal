...
К массообменным процессам относят абсорбцию, ректификацию, сушку, адсорбцию, десорбцию, ионный обмен, экстрагирование, кристаллизацию, растворение и жидкостную экстракцию. В химических и пищевых производствах они нужны для очистки, концентрирования и выделения целевых компонентов.
...
![К определению градиента концентраций](/images/courses/chemical-process-engineering/chapter-10/fig-10-1.webp)
...
![Пограничные пленки у границы раздела фаз](/images/courses/chemical-process-engineering/chapter-10/fig-10-2.webp)
...
![Структура турбулентного потока](/images/courses/chemical-process-engineering/chapter-10/fig-10-3.webp)
...
- связывать «массоотдача» с аппаратурным оформлением химического производства;
