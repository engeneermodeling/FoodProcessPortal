...
Гидравлика рассматривает законы равновесия и движения жидкостей и газов. Для аппаратов химических производств эти законы нужны при расчете трубопроводов, резервуаров, ферментеров, теплообменников, насосов, компрессоров и систем подачи сред. Жидкость рассматривают как сплошную среду, а давление в любой точке передается во всех направлениях.
...
![Рис. 2.1. К выводу дифференциальных уравнений равновесия Эйлера](/images/courses/chemical-process-engineering/chapter-02/fig-2-1.webp)
...
![Рис. 2.2. Основное уравнение гидростатики](/images/courses/chemical-process-engineering/chapter-02/fig-2-2.webp)
...
![Рис. 2.3. Схема к закону Паскаля](/images/courses/chemical-process-engineering/chapter-02/fig-2-3.webp)

Для измерения давления применяют жидкостные манометры, вакуумметры и пружинные манометры. В химическом оборудовании контроль давления особенно важен в реакторах, колоннах, фильтрах и линиях подачи.

![Рис. 2.4. Жидкостный манометр](/images/courses/chemical-process-engineering/chapter-02/fig-2-4.webp)
...
![Рис. 2.5. К выводу уравнения Бернулли](/images/courses/chemical-process-engineering/chapter-02/fig-2-5.webp)
...
![Рис. 2.7. Схема установки Рейнольдса](/images/courses/chemical-process-engineering/chapter-02/fig-2-7.webp)
...
![Рис. 2.8. К выводу формул Стокса и Пуазейля](/images/courses/chemical-process-engineering/chapter-02/fig-2-8.webp)
...
- связывать «уравнение Бернулли» с аппаратурным оформлением химического производства;
