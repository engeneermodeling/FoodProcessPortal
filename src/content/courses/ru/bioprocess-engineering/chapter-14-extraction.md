...
![Способы обработки сырья перед экстрагированием](/images/courses/bioprocess-engineering/chapter-14/fig-14-1.webp)
*Рис. 14.1. Способы обработки сырья перед экстрагированием*

![Классификация экстрагентов](/images/courses/bioprocess-engineering/chapter-14/fig-14-2.webp)
...
![Схема переноса массы целевого компонента](/images/courses/bioprocess-engineering/chapter-14/fig-14-3.webp)
...
![Экстракционные кривые противоточного и прямоточного процессов](/images/courses/bioprocess-engineering/chapter-14/fig-14-4.webp)
...
![Треугольная диаграмма для системы твердое тело - жидкость](/images/courses/bioprocess-engineering/chapter-14/fig-14-5.webp)
...
![Определение состава и количества образованных смесей](/images/courses/bioprocess-engineering/chapter-14/fig-14-6.webp)
*Рис. 14.6. Определение состава и количества образованных смесей*

![Схема n-секционного противоточного экстрагирования](/images/courses/bioprocess-engineering/chapter-14/fig-14-7.webp)
*Рис. 14.7. Схема n-секционного противоточного экстрагирования*

![Графический расчет многоступенчатого противоточного экстрагирования из твердых тел](/images/courses/bioprocess-engineering/chapter-14/fig-14-8.webp)
*Рис. 14.8. Графический расчет многоступенчатого противоточного экстрагирования из твердых тел*

![Графическое определение числа ступеней концентрации](/images/courses/bioprocess-engineering/chapter-14/fig-14-9.webp)
...
![Классификация методов интенсификации процесса экстрагирования](/images/courses/bioprocess-engineering/chapter-14/fig-14-10.webp)
*Рис. 14.10. Классификация методов интенсификации процесса экстрагирования*

![Общая классификация аппаратов для экстрагирования из твердых тел](/images/courses/bioprocess-engineering/chapter-14/fig-14-11.webp)
*Рис. 14.11. Общая классификация аппаратов для экстрагирования из твердых тел*

![Классификация экстракционной аппаратуры по режиму работы](/images/courses/bioprocess-engineering/chapter-14/fig-14-12.webp)
...
![Схемы экстракторов периодического действия](/images/courses/bioprocess-engineering/chapter-14/fig-14-13.webp)
*Рис. 14.13. Схемы экстракторов периодического действия*

![Экстрактор с восходящим потоком экстрагента](/images/courses/bioprocess-engineering/chapter-14/fig-14-14.webp)
*Рис. 14.14. Экстрактор с восходящим потоком экстрагента*

![Экстрактор с нисходящим потоком экстрагента](/images/courses/bioprocess-engineering/chapter-14/fig-14-15.webp)
*Рис. 14.15. Экстрактор с нисходящим потоком экстрагента*

![Комбинированный экстрактор периодического действия](/images/courses/bioprocess-engineering/chapter-14/fig-14-16.webp)
*Рис. 14.16. Комбинированный экстрактор периодического действия*

![Экстрактор с кавитационным эффектом](/images/courses/bioprocess-engineering/chapter-14/fig-14-17.webp)
*Рис. 14.17. Экстрактор с кавитационным эффектом*

![Виброэкстрактор с сетчатым контейнером](/images/courses/bioprocess-engineering/chapter-14/fig-14-18.webp)
*Рис. 14.18. Виброэкстрактор с сетчатым контейнером*

![Ротационная диффузионная установка](/images/courses/bioprocess-engineering/chapter-14/fig-14-19.webp)
*Рис. 14.19. Ротационная диффузионная установка*

![Схема шнекового горизонтального экстрактора](/images/courses/bioprocess-engineering/chapter-14/fig-14-20.webp)
*Рис. 14.20. Схема шнекового горизонтального экстрактора*

![Шнековый горизонтальный экстрактор](/images/courses/bioprocess-engineering/chapter-14/fig-14-21.webp)
*Рис. 14.21. Шнековый горизонтальный экстрактор*

![Пружинно-лопастной горизонтальный экстрактор](/images/courses/bioprocess-engineering/chapter-14/fig-14-22.webp)
*Рис. 14.22. Пружинно-лопастной горизонтальный экстрактор*

![Экстрактор наклонного типа](/images/courses/bioprocess-engineering/chapter-14/fig-14-23.webp)
*Рис. 14.23. Экстрактор наклонного типа*

![Двухколонный экстрактор типа НД-1000](/images/courses/bioprocess-engineering/chapter-14/fig-14-24.webp)
*Рис. 14.24. Двухколонный экстрактор типа НД-1000*

![Принципиальная схема виброэкстрактора](/images/courses/bioprocess-engineering/chapter-14/fig-14-25.webp)
*Рис. 14.25. Принципиальная схема виброэкстрактора*

![Вибротранспортирующая тарелка](/images/courses/bioprocess-engineering/chapter-14/fig-14-26.webp)
*Рис. 14.26. Вибротранспортирующая тарелка*

![Вибрационный экстрактор](/images/courses/bioprocess-engineering/chapter-14/fig-14-27.webp)
...
- связывать «система твердое тело - жидкость» с аппаратурным оформлением биотехнологического производства;
