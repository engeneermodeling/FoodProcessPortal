...
На следующем проходе стоит добавить короткий расчетный пример производительности мембраны и сравнительную таблицу RO/NF/UF/MF для биотехнологических задач.
