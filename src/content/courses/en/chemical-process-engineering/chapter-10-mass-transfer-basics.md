...
Absorption, rectification, drying, adsorption, desorption, ion exchange, extraction, crystallization, dissolution and liquid extraction are typical mass-transfer processes. In chemical and food production they are used to purify, concentrate, isolate target components and prepare products for storage.
...
![Defining the concentration gradient](/images/courses/chemical-process-engineering/chapter-10/fig-10-1.webp)
...
![Boundary films at the phase interface](/images/courses/chemical-process-engineering/chapter-10/fig-10-2.webp)
...
![Turbulent-flow structure](/images/courses/chemical-process-engineering/chapter-10/fig-10-3.webp)
...
Thermodiffusion occurs when temperature and pressure gradients influence mass transfer along with the concentration gradient. This is important in heating, cooling, sterilization and concentration zones of chemical equipment.
...
- connect "mass transfer coefficient" with equipment design in chemical production;
