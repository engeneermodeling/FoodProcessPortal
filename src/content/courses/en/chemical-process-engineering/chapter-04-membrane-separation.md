---
title: "Chapter 4. Membrane Separation Processes"
course: "chemical-process-engineering"
course_title: "Processes and Equipment of Chemical Production"
chapter: 4
description: "Reverse osmosis, nano-, ultra- and microfiltration, diafiltration and membrane equipment."
updated: "2026-08-27"
---
...
- 4.2. Theoretical basis of pressure-driven membrane processes
- 4.3. Diafiltration
...
Membrane separation processes use semipermeable barriers that allow some components to pass while retaining others. In chemical production they are used to concentrate solutions, purify process water, desalinate streams, separate colloidal systems and filter heat-sensitive solutions.
...
![Fig. 4.1. Osmosis and reverse-osmosis process schemes](/images/courses/chemical-process-engineering/chapter-04/fig-4-1.webp)
...
Diafiltration combines membrane separation with solvent addition. It removes low-molecular impurities from a high-molecular product solution without major product loss. In chemical production it is useful for washing concentrates, purifying polymer solutions and preparing process water.
...
![Fig. 4.2. Principle schemes of diafiltration](/images/courses/chemical-process-engineering/chapter-04/fig-4-2.webp)

### 4.4. Membrane Equipment

Membrane equipment must provide large membrane area, uniform flow distribution, cleaning capability, sanitation and replacement of membrane elements. For chemical media, material resistance, fouling control, tightness and stable operating conditions are especially important.

Filter-press type devices are convenient for flat membranes and laboratory or pilot installations.

![Fig. 4.3. Filter-press type membrane apparatus](/images/courses/chemical-process-engineering/chapter-04/fig-4-3.webp)

Tubular membrane elements resist fouling and are suitable for viscous or contaminated suspensions.

![Fig. 4.4. Tubular membrane element schemes](/images/courses/chemical-process-engineering/chapter-04/fig-4-4.webp)
...
![Fig. 4.6. Module with hollow-fibre membranes](/images/courses/chemical-process-engineering/chapter-04/fig-4-6.webp)
...
![Fig. 4.7. Batch pressure-driven membrane apparatus](/images/courses/chemical-process-engineering/chapter-04/fig-4-7.webp)

Continuous schemes use one or several stages with circulation loops to maintain productivity and stable permeate quality.

![Fig. 4.8. Continuous pressure-driven membrane apparatuses with circulation loops](/images/courses/chemical-process-engineering/chapter-04/fig-4-8.webp)

## After studying this chapter, students should be able to

- explain the role of "membrane" within the chapter;
- connect "reverse osmosis" with equipment design in chemical production;
- distinguish the main parameters that affect "ultrafiltration";
- justify process selection or evaluation through "diafiltration".
...
<label class="course-test-option">
  ...
  <span class="course-test-letter">D</span>
  <span>Osmosis and reverse osmosis process schemes</span>
</label>
</div>
<p class="course-test-feedback" data-course-test-feedback></p>
</fieldset>
