...
Extraction is a mass-transfer process in which one or more components are removed from a solid or liquid material by a solvent that selectively dissolves the target substance. In chemical and food production it is used to obtain enzymes, plant extracts, aromatic compounds, biologically active substances and other target components.
...
![Raw-material pretreatment methods before extraction](/images/courses/chemical-process-engineering/chapter-14/fig-14-1.webp)
*Fig. 14.1. Raw-material pretreatment methods before extraction*

![Classification of extractants](/images/courses/chemical-process-engineering/chapter-14/fig-14-2.webp)
...
![Mass-transfer scheme for the target component](/images/courses/chemical-process-engineering/chapter-14/fig-14-3.webp)
...
![Extraction curves for counter-current and cocurrent processes](/images/courses/chemical-process-engineering/chapter-14/fig-14-4.webp)
...
![Triangular diagram for a solid-liquid system](/images/courses/chemical-process-engineering/chapter-14/fig-14-5.webp)
...
![Determining the composition and amount of formed mixtures](/images/courses/chemical-process-engineering/chapter-14/fig-14-6.webp)
*Fig. 14.6. Determining the composition and amount of formed mixtures*

![Scheme of n-section counter-current extraction](/images/courses/chemical-process-engineering/chapter-14/fig-14-7.webp)
*Fig. 14.7. Scheme of n-section counter-current extraction*

![Graphical calculation of multistage counter-current extraction from solids](/images/courses/chemical-process-engineering/chapter-14/fig-14-8.webp)
*Fig. 14.8. Graphical calculation of multistage counter-current extraction from solids*

![Graphical determination of concentration stages](/images/courses/chemical-process-engineering/chapter-14/fig-14-9.webp)
...
![Classification of extraction-process intensification methods](/images/courses/chemical-process-engineering/chapter-14/fig-14-10.webp)
*Fig. 14.10. Classification of extraction-process intensification methods*

![General classification of equipment for extraction from solids](/images/courses/chemical-process-engineering/chapter-14/fig-14-11.webp)
*Fig. 14.11. General classification of equipment for extraction from solids*

![Classification of extraction equipment by operating mode](/images/courses/chemical-process-engineering/chapter-14/fig-14-12.webp)
...
![Batch extractor schemes](/images/courses/chemical-process-engineering/chapter-14/fig-14-13.webp)
*Fig. 14.13. Batch extractor schemes*

![Extractor with upward extractant flow](/images/courses/chemical-process-engineering/chapter-14/fig-14-14.webp)
*Fig. 14.14. Extractor with upward extractant flow*

![Extractor with downward extractant flow](/images/courses/chemical-process-engineering/chapter-14/fig-14-15.webp)
*Fig. 14.15. Extractor with downward extractant flow*

![Combined batch extractor](/images/courses/chemical-process-engineering/chapter-14/fig-14-16.webp)
*Fig. 14.16. Combined batch extractor*

![Extractor with a cavitation effect](/images/courses/chemical-process-engineering/chapter-14/fig-14-17.webp)
*Fig. 14.17. Extractor with a cavitation effect*

![Vibroextractor with a mesh container](/images/courses/chemical-process-engineering/chapter-14/fig-14-18.webp)
*Fig. 14.18. Vibroextractor with a mesh container*

![Rotary diffusion unit](/images/courses/chemical-process-engineering/chapter-14/fig-14-19.webp)
*Fig. 14.19. Rotary diffusion unit*

![Horizontal screw extractor scheme](/images/courses/chemical-process-engineering/chapter-14/fig-14-20.webp)
*Fig. 14.20. Horizontal screw extractor scheme*

![Horizontal screw extractor](/images/courses/chemical-process-engineering/chapter-14/fig-14-21.webp)
*Fig. 14.21. Horizontal screw extractor*

![Spring-blade horizontal extractor](/images/courses/chemical-process-engineering/chapter-14/fig-14-22.webp)
*Fig. 14.22. Spring-blade horizontal extractor*

![Inclined extractor](/images/courses/chemical-process-engineering/chapter-14/fig-14-23.webp)
*Fig. 14.23. Inclined extractor*

![ND-1000 double-column extractor](/images/courses/chemical-process-engineering/chapter-14/fig-14-24.webp)
*Fig. 14.24. ND-1000 double-column extractor*

![Vibroextractor principle scheme](/images/courses/chemical-process-engineering/chapter-14/fig-14-25.webp)
*Fig. 14.25. Vibroextractor principle scheme*

![Vibrotransport tray](/images/courses/chemical-process-engineering/chapter-14/fig-14-26.webp)
*Fig. 14.26. Vibrotransport tray*

![Vibration extractor](/images/courses/chemical-process-engineering/chapter-14/fig-14-27.webp)
*Fig. 14.27. Vibration extractor*

## After studying this chapter, students should be able to

- explain the role of "extractant" within the chapter;
- connect "solid-liquid system" with equipment design in chemical production;
