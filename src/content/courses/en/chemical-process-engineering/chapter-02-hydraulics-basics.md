...
Hydraulics describes equilibrium and motion of liquids and gases. In chemical equipment it is used for calculating pipelines, tanks, reactors, heat exchangers, pumps, compressors and feed systems. A liquid is treated as a continuous medium, and pressure at a point is transmitted in all directions.
...
![Fig. 2.1. Derivation of Euler differential equilibrium equations](/images/courses/chemical-process-engineering/chapter-02/fig-2-1.webp)
...
![Fig. 2.2. Basic hydrostatic equation](/images/courses/chemical-process-engineering/chapter-02/fig-2-2.webp)
...
![Fig. 2.3. Scheme for Pascal's law](/images/courses/chemical-process-engineering/chapter-02/fig-2-3.webp)

Liquid manometers, vacuum gauges and elastic manometers are used for pressure measurement. In chemical equipment pressure control is essential in reactors, columns, filters and feed lines.

![Fig. 2.4. Liquid manometer](/images/courses/chemical-process-engineering/chapter-02/fig-2-4.webp)
...
![Fig. 2.5. Derivation of Bernoulli equation](/images/courses/chemical-process-engineering/chapter-02/fig-2-5.webp)
...
![Fig. 2.7. Reynolds experiment setup](/images/courses/chemical-process-engineering/chapter-02/fig-2-7.webp)
...
![Fig. 2.8. Stokes and Poiseuille formulas](/images/courses/chemical-process-engineering/chapter-02/fig-2-8.webp)
...
The pipeline characteristic shows how required head increases with flow rate. The operating point is the intersection of the pump characteristic and the pipeline characteristic. In chemical production this determines stable feeding, energy use and the permissible load on equipment.

## After studying this chapter, students should be able to

- explain the role of "hydrostatic pressure" within the chapter;
- connect "Bernoulli equation" with equipment design in chemical production;
