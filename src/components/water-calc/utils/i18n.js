...
i18nDict.ru = {
  ...i18nDict.uk,
  "hero.eyebrow": "Термодинамический калькулятор",
  "hero.title1": "Теплофизические",
  "hero.title2": "свойства воды",
  "hero.desc":
    "Введите температуру — получите плотность, теплоёмкость, теплопроводность, вязкость и другие свойства воды.",
  "input.cardTitle": "Параметры расчёта",
  "input.tempLabel": "Температура",
  "input.pressureLabel": "Давление",
  "input.unitsLabel": "Единицы",
  "input.calcBtn": "Рассчитать",
  "input.rangePrefix": "Допустимые диапазоны:",
  "input.rangeAuto": "авто: жидкость / пар",
  "results.pressureLabel": "Давление",
  "results.tsatLabel": "T насыщения",
  "results.tsatHint": "Нажмите, чтобы подставить в поле температуры",
  "results.tmeltLabel": "T замерзания",
  "results.tmeltHint": "Температура плавления льда при текущем давлении",
  "footer.notePrefix": "Рассчитано по аппроксимационным формулам стандарта",
  "footer.noteSuffix": ". Погрешность < 1% в рабочем диапазоне.",
  "chart.title": "График свойства от температуры",
  "chart.propLabel": "Свойство:",
  "chart.legendLiquid": "жидкая вода",
  "chart.legendSteam": "перегретый пар",
  "chart.legendTsat": "T насыщения",
  "chart.legendCurrent": "текущая T",
  "chart.legendIce": "лёд",
  "chart.exportPng": "Скачать PNG",
  "phase.water": "Жидкая вода",
  "phase.steam": "Перегретый пар",
  "phase.ice": "Лёд",
  "err.notNumber": "Пожалуйста, введите числовое значение температуры.",
  "err.outOfRange": "Значение {val} выходит за пределы допустимого диапазона ({range}).",
  "err.outOfPressure":
    "Давление {val} выходит за пределы допустимого диапазона (0.001 — 100 МПа).",
  "export.title": "Экспорт результатов",
  "export.csv": "Скачать CSV",
  "export.pdf": "Сохранить как PDF",
  "history.title": "История расчётов",
  "history.clear": "Очистить",
  "history.empty": "Пока нет сохранённых расчётов.",
  "tabs.aria": "Режим калькулятора",
  "tabs.main": "Свойства воды по температуре и давлению",
  "tabs.sat": "Насыщенный пар",
  "sat.title": "Свойства насыщенного пара",
  "sat.tabByTemp": "По температуре",
  "sat.tabByPressure": "По давлению",
  "sat.inputTemp": "Температура насыщения",
  "sat.inputPressure": "Давление насыщения",
  "sat.calcByTemp": "Рассчитать по T",
  "sat.calcByPressure": "Рассчитать по P",
};

const SUPPORTED = ["uk", "ru", "en", "de"];
